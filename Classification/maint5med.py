...
wandb.init(
    ...
    name="t5-base-classification-AGNews-7",
    config={
        "learning_rate": 1e-4,
...
# Load the T5-base tokenizer and model for sequence classification
...
training_args = TrainingArguments(
    ...
    logging_steps=2500,
    save_steps=2500,
    per_device_train_batch_size=16,  # Reduced for T5-base
