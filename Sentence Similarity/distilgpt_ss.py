...
import wandb
wandb.init(project="Dravida Ulagam - small", name="distillgpt-sick-sentencesimilarity-nov28-run2-test")

# Load tokenizer and model
tokenizer = GPT2Tokenizer.from_pretrained("distilgpt2")
tokenizer.pad_token = tokenizer.eos_token  # Set padding token
model = GPT2ForSequenceClassification.from_pretrained("distilgpt2", num_labels=6)  # 6 classes (0-5)
...
training_args = TrainingArguments(
    output_dir="./distilgpt2-sick-results-3",
    evaluation_strategy="steps",
    eval_steps=25,
    per_device_train_batch_size=1,
    per_device_eval_batch_size=1,
    num_train_epochs=10,
    logging_dir="./distilgpt2-sick-logs-3",
    logging_steps=25,
...
# Save the model
model.save_pretrained("./distilgpt2-sick-final")
tokenizer.save_pretrained("./distilgpt2-sick-final")