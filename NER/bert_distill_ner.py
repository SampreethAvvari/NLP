...
wandb.init(project="Dravida Ulagam - Small", name='distillbertsmall-ner-oct31-run2-5epochs', config={
...
training_args = TrainingArguments(
    output_dir="/scratch/ds7395/nlp_proj/distillbert_small_ner_run2_5epcochs",
