...
wandb.init(project="Dravida Ulagam - Medium", name='t5base-ner-nov7-run1', config={
    "model": "t5-base",
    "batch_size": 32,
    "learning_rate": 2e-4,
    "epochs": 5,
...
training_args = Seq2SeqTrainingArguments(
    output_dir="/scratch/ds7395/nlp_proj/t5_base_ner_run1",
    evaluation_strategy="epoch",
    learning_rate=2e-4,
    per_device_train_batch_size=16,  # Reduce to 8 if memory issues occur
